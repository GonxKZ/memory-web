                        ...
                        <div className="flex flex-wrap gap-1 max-h-24 overflow-y-auto p-2 bg-gray-50 rounded">
                          {cfi.attacks.rop.gadgetsUsed.slice(-20).map((gadget, index) => (
                            <div
                              ...
                              title={`
                                Gadget utilizado: Dirección 0x${(0x400000 + gadget * 0x1000).toString(16).toUpperCase()}
                              `}
                            >
                              {gadget % 10}
                            </div>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1 max-h-24 overflow-y-auto p-2 bg-gray-50 rounded">
                          {cfi.attacks.jop.dispatchersUsed.slice(-20).map((dispatcher, index) => (
                            <div
                              key={index}
                              className="w-6 h-6 rounded flex items-center justify-center text-xs font-mono bg-green-500 text-white"
                              title={`
                                Dispatcher utilizado: Dirección 0x${(0x400000 + dispatcher * 0x1000).toString(16).toUpperCase()}
                              `}
                            >
                              {dispatcher % 10}
                            </div>
                    ...
                    <div className="space-y-3">
                      <div className="grid grid-cols-2 gap-2">
                        <div className="p-2 bg-gray-50 rounded text-center">
                          ...
                          <div className="font-semibold text-gray-600">
                            {cfi.performance.overhead.toFixed(1)}%
                          </div>
                        </div>
                        <div className="p-2 bg-gray-50 rounded text-center">
                          <div className="text-xs text-gray-500 mb-1">Tiempo Ejecución</div>
                          <div className="font-semibold text-gray-600">
                            {cfi.performance.executionTime.toFixed(0)} ms
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div className="p-2 bg-gray-50 rounded text-center">
                          ...
                          <div className="font-semibold text-gray-600">
                            {cfi.performance.memoryUsage.toFixed(0)} KB
                          </div>
                        </div>
                        <div className="p-2 bg-gray-50 rounded text-center">
                          <div className="text-xs text-gray-500 mb-1">Frecuencia Chequeos</div>
                          <div className="font-semibold text-gray-600">
                            {cfi.performance.checkFrequency.toFixed(0)}/s
                          </div>
                        </div>
                      </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-4 bg-blue-50 rounded">
              <div className="font-semibold text-blue-800 mb-2">CFI Suave</div>
            ...
            <div className="p-4 bg-green-50 rounded">
              <div className="font-semibold text-green-800 mb-2">CFI Dura</div>
