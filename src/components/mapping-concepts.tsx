    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-600 max-w-3xl mx-auto">
          El mapeo de memoria define cómo las direcciones virtuales se 
          traducen a direcciones físicas en el sistema. Es fundamental 
          para que múltiples programas puedan ejecutarse simultáneamente 
          sin interferir entre sí. Es como tener una biblioteca con muchas 
          estanterías (memoria física) pero permitir que cada lector tenga 
          su propio catálogo personalizado (memoria virtual).
        </p>
      </div>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-blue-700 mt-3">
                ...
                virtuales mientras comparten la memoria física del sistema. La unidad de gestión 
                de memoria (MMU) es el componente del hardware que traduce direcciones virtuales 
                en direcciones físicas, actuando como el bibliotecario que convierte las 
                referencias del catálogo virtual en ubicaciones reales de estanterías.
              </p>
              
              <div className="mt-4 p-3 bg-white rounded-lg border">
                <div className="font-semibold text-gray-800 mb-2">Visualización del proceso de traducción:</div>
                <div className="font-mono text-sm">
                  <div>// Proceso ve direcciones virtuales</div>
                  <div>Virtual Address: 0x12345678</div>
                  <div className="my-1 text-center">↓ MMU</div>
                  <div>// MMU usa tablas de páginas para traducir</div>
                  <div>Page Table Lookup: VPN 0x12345 → PPN 0x56789</div>
                  <div className="my-1 text-center">↓</div>
                  <div>// Resultado es dirección física real</div>
                  <div>Physical Address: 0x56789678</div>
                </div>
              </div>
            </div>
          </div>
