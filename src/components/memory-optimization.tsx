...
interface MemoryOptimizationTechniqueProps {
...
export function MemoryOptimizationTechnique({ 
  technique,
  name,
  description,
  whenToUse,
  ...
  technicalDetails,
  examples
}: MemoryOptimizationTechniqueProps) {
      ...
      <Card className="bg-yellow-50 border-yellow-200">
        <CardContent className="p-6">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="font-semibold text-yellow-800 mb-2">Principios de optimización</h3>
